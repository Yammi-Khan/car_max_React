        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
          ...
          <div className="p-4 md:w-1/3 flex">
            <div className="flex-grow pl-6">
              ...
              <img className="mt-3" src="https://th.bing.com/th/id/R.3a6d0ca3c8ebfc71c425a3899c178eea?rik=1nBbbF8TjGparQ&pid=ImgRaw&r=0" alt="SUV cars" />
              <button onClick={HandleSUV} className="mt-7 text-black font-mono inline-flex  items-center">EXPLORE
                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                  <path d="M5 12h14M12 5l7 7-7 7"></path>
                </svg>
              </button>
